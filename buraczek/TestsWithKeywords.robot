...
IfStatements
    ...
    Log    ${Log}
    ###
    ${var1} =    Multiply Integer by 2 and reset if over 8    ${var1}
    ${var1} =    Multiply Integer by 2 and reset if over 8    ${var1}

*** Keywords ***
Multiply Integer by 2 and reset if over 8
    [Arguments]    ${var1}
...
Multiply two given variables
    ...
    ${converted_input2}=    Convert To Integer    ${inputSet_integer2}
    ${converted_input3}=    Convert To Integer    ${input_integer3}
    ${output}=    Evaluate    ${converted_input1} * ${converted_input2} * ${input_integer3}
    [Return]    ${output}
